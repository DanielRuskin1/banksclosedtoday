...
"Are Banks Closed Today?" is very simple to setup on Heroku.
1. Fork the repository.
2. Create an application on Heroku with the below dependencies setup.
3. Deploy to your Heroku application.

## Dependencies

In addition to the various dependencies specified in the Gemfile, some additional services are also used.  The table below shows all services that are currently used by the app.
