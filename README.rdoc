...
== Dependencies
In addition to the various dependencies specified in the Gemfile, additional services are also used.  The table below shows all such services that are currently used by the app.
